...
from leo.callbacks.early_stopping import EarlyStopping
from leo.datasets.image_classification import ImageDataset
from leo.models.custom_model import Model
from torch.nn import functional as F

INPUT_PATH = "../out_res/input/"
MODEL_PATH = "../out_res/models/"
...
if __name__ == "__main__":
    ...
    model = DiabeticModel(num_classes=len(lbl_enc.classes_))
